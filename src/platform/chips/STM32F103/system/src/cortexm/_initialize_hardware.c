...
//
// Edited and adapted by Peter Oppermann
// ----------------------------------------------------------------------------
...
__initialize_hardware_early(void)
{
	...
	// Call a 1s busy waiting loop to give jtag a change to take over
	// since WaitForInterrupt breaks the jtag and a endlessly waiting program
	// may make the core unuseable (http://openocd.org/doc/html/General-Commands.html)
